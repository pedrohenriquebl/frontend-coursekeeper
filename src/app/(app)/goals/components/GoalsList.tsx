                ...
                hasFilteredGoals ? (
                    filteredGoals.map((goal: Goal) => (
                        <div
                            key={goal.id}
                            className={cn(
                                "bg-gray-800/60 backdrop-blur-sm rounded-xl p-6 shadow-lg border transition-all duration-200",
                        ...
                        >
                            ...
                            <div className="flex items-start justify-between mb-4 flex-wrap sm:no-wrap">
                                <div className="flex-1">
                                    ...
                                    {goal.topic && (
                                        <span className="inline-block bg-gray-600/50 px-2 py-1 rounded text-xs text-gray-300">
                                            {goal.topic}
                                        </span>
                                    )}
                                </div>
